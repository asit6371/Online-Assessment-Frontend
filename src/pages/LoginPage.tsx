...
function LoginPage() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Redirect to landing page — navbar will now show profile
      navigate("/");
      ...
      >
        <div
          style={{
            ...
            padding: "40px 36px",
            boxShadow:
              "0 24px 64px rgba(0,0,0,0.5), 0 0 0 1px rgba(255,138,0,0.04)",
          }}
        >
          {/* Header */}
          ...
          >
            <div
              style={{ flex: 1, height: 1, backgroundColor: "rgba(255,255,255,0.07)" }}
            />
          ...
          <p style={{ textAlign: "center", fontSize: 14, color: "#6B7280" }}>
            ...
            <span
              ...
              style={{ color: "#FF8A00", cursor: "pointer", fontWeight: 600 }}
              onMouseEnter={(e) =>
